...
import com.janirefernandez.paging3example.databinding.SeparatorItemBinding

class SeparatorViewHolder(view: View) : RecyclerView.ViewHolder(view) {

    private val binding = SeparatorItemBinding.bind(view)

    fun render(separatorText: String) {
